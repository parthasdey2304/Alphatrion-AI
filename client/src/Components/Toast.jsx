...
const Toast = ({ message }) => {
    ...
    return (
        <div id="toast-default" class={`flex items-center w-full max-w-xs p-4 text-gray-500 bg-white/30 rounded-lg shadow absolute bottom-4 right-4` + (show? "" : " hidden")} role="alert">
